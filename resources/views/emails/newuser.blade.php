                                                    ...
                                                    <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                                                        <tbody><tr>
                                                            ...
                                                            <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                                                ...
                                                                <p style="font-size:18px !important;"><span style="-webkit-text-size-adjust: auto;-webkit-text-stroke-width: 0px;background-color: #FFFFFF;caret-color: #A3A6B2;color: #A3A6B2;display: inline !important;float: none;font-family: times new roman,sans-serif;font-size: 16px;font-style: normal;font-variant-caps: normal;font-weight: normal;letter-spacing: normal;orphans: auto;text-align: start;text-decoration: none;text-indent: 0px;text-transform: none;white-space: normal;widows: auto;word-spacing: 0px;">Welcome to Abbott OCT App. Before you can start using it, you need to confirm your registration</span></p>
                                                    ...
                                                    <table class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 3px;background-color: #3c1053;" cellspacing="0" cellpadding="0" border="0">
                                                        ...
                                                        <tr>
                                                            <td class="mcnButtonContent" style="font-family: Helvetica; font-size: 18px; padding: 18px;" valign="middle" align="center">
                                                                <p><a style="color:white;text-decoration:none" href="{{ route('userConfirm',$userApp->id )}}">Confirm</a></p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
